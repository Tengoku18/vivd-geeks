...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    takeaways: [
      "Answer engines summarise, so fewer links get shown; being cited matters more than ranking tenth.",
      "Clarity beats volume: clean structure and honest answers outperform vague authority.",
      "AEO extends SEO, it does not replace it, and the technical foundations still apply.",
  ...
  },
  {
    ...
    takeaways: [
      "A website is your first (and sometimes last) sales conversation, so treat it like one.",
